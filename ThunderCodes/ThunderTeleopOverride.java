...
@TeleOp(name = "ThunderTeleopOverride")
public class ThunderTeleopOverride extends LinearOpMode {
    ...
    //Soft limits
    static final int ExtensionLimit = -100000;
    static final int ArmLimit = 300000;
    static final int JointLimit = -70000;
...
//arm control
                        ...
                        Joint.setTargetPosition(WristTarget);
                        ...
                        Joint.setPower(ARMSPEED);
                        Lift.setPower(ARMSPEED);
                        
                        double ArmInputraw = -gamepad2.left_stick_y * 50;
                        double LiftInputraw = gamepad2.right_stick_y * 50;
                        
                        int ArmInput = (int) Math.floor(ArmInputraw);
                        int LiftInput = (int) Math.floor(LiftInputraw);
                        
                        ArmTarget = ArmTarget + (ArmInput);
                        LiftTarget = LiftTarget + (LiftInput);
                       
                       //wrist target
                         if (gamepad2.dpad_up) {
                          WristTarget = WristTarget + 6;
                          } else if (gamepad2.dpad_down) {
                           WristTarget = WristTarget - 6;
                          } else {
                          WristTarget = WristTarget;
                          } 
    ...
    public void Transit(double speed) {
                    int newArmTarget;
                    int newJointTarget;
                    int newLiftTarget;
